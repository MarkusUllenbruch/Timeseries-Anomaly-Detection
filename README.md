...
We choose a threshold by taking the mean of the reconstruction errors of the normal samples plus a hyperparameter times one standard deviation of the reconstruction loss of normal samples. We evaluate the anomaly detection classifier based on reconstruction error with our test dataset. The confusion matrix of Training and Test Dataset can be seen below:
